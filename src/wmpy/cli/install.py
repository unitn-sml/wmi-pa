...
from wmpy.cli.installers.latte import LatteInstaller
from wmpy.cli.log import logger
from wmpy.cli.utils import get_default_include_lib_paths, safe_cmd
...
def run(args: argparse.Namespace) -> None:
    ...
    print(
        "Installation complete. You can now use wmpy with the installed dependencies."
    )
