from pysmt.shortcuts import GE, Real, And, LE, Ite, Iff, Bool, Symbol, Times, Or, Not, Plus, Equals, FreshSymbol
...
def test_reserved_variables_name():
    ...
    chi = And(
        GE(x, Real(0)), LE(x, Real(2)), GE(y, Real(2)), LE(y, Real(4)), Iff(a, LE(x, Real(1))), Iff(b, LE(y, Real(3)))
    )
