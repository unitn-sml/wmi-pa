...
def test_no_booleans_constant_weight():
    ...
    result_sa_pa_sk, _ = wmi.computeMI(phi, mode=WMI.MODE_SAE4WMI)
...
def test_no_booleans_condition_weight():
    ...
    result_sa_pa_sk, _ = wmi.computeWMI(phi, mode=WMI.MODE_SAE4WMI)
...
def test_batch_of_query_constant_weight():
    ...
    result_sa_pa_sk, _ = wmi.computeMI_batch([phi1, phi2], mode=WMI.MODE_SAE4WMI)
...
def test_batch_of_query():
    ...
    result_sa_pa_sk, _ = wmi.computeWMI_batch([phi1, phi2], mode=WMI.MODE_SAE4WMI)
...
def test_setting_domA():
    ...
    result_sa_pa_sk, _ = wmi.computeMI(phi, mode=WMI.MODE_SAE4WMI, domA={a, b})
