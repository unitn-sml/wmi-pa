...
class Weights:
    ...
    Attributes:
        ...
        labelling (FNode): The pysmt formula representing all the correlations between the labels
            and the actual conditions (e.g: cond_3 <-> (x < 5)).
    ...
    def weight_from_assignment(self, assignment, on_labels=True):
        ...
        if on_labels:
            ...
            assert None not in cond_assignment, "Couldn't retrieve the complete assignment"
    ...
    def _evaluate_weight(self, node, assignment, conditions, atom_assignment):
        ...
        Args:
            ...
            assignment (list(bool)): The dictionary containing the truth value of each weight codition evaluated.
            conditions (dict {FNode: int}): The dictionary mapping each condition to the respective index.
        ...
        # this condition contains, for example, the Times operator
            ...
            return get_env().formula_manager.create_node(node_type=node.node_type(), args=tuple(new_children))
